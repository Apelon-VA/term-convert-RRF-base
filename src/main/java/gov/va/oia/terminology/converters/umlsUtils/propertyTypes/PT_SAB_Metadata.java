...
public class PT_SAB_Metadata extends PropertyType
{
	public PT_SAB_Metadata()
	{
		...
		addProperty("Versioned Source Abbreviation", null, "VSAB", "The versioned source abbreviation for a source, e.g., NDDF_2004_11_03");
		addProperty("Root Source Abbreviation", null, "RSAB","The root source abbreviation, for a source e.g. NDDF");
